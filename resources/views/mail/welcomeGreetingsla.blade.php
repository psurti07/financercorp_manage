    ...
    <div class="es-wrapper-color" style="background-color: #f9f9f9;">
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            style="
                ...
                background-image: url(https://financercorp.com/assets/images/mail-bgm.png);
                background-color: #f9f9f9;
                "
            background="https://financercorp.com/front/images/bg-01.webp">
            <tbody>
                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <a target="_blank"
                                                                                            ...
                                                                                            <img src="https://financercorp.com/public/front/images/logo/logo.png"
                                                                                                alt="financercorp"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <p
                                                                                            style="font-size:2.2rem;color:#02a6fc;font-weight:600">
                                                                                            Congratulations !
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                            align="left"
                                                            style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #E9F2FB;border: 1px solid #02a6fc;  border-radius: 12px; display: block;">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p20b" align="left"
                                                                        style="padding: 0; margin: 0; width: 600px;">
                                                                        <h3 style="text-align:center; color: #02a6fc;">
                                                                            Order Details
                                                                        </h3>
                                                                        <hr>
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            width="100%" bgcolor="#ffffff"
                                                                            style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px;/* border: 1px solid #02a6fc; */ background-color: transparent;"
                                                                            role="presentation">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td
                                                                                    ...
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <p style="margin: 0;">Payment
                                                                                            Amount :
                                                                                        <h5 style="margin: 0;">
                                                                                            &#8377;{{ formatePriceIndia($order_amount) }}
                                                                                        </h5>
                                                                                        </p>
                                                                                        <p style="margin: 0;">
                                                                                            Transaction Date/Time:
                                                                                        <h5 style="margin: 0;">
                                                                                            {{ date('M d, Y', strtotime($order_date)) }}
                                                                                        </h5>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <p style="font-size:13px">⚡Our
                                                                                            Loan Consultant will reach
                                                                                            out to you within 24 to 48
                                                                                            hours and guide you towards
                                                                                            your loan process!
                                                                                        <p>
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        style="padding: 20px; margin: 0; line-height: 1.5rem;background-color: #E9F2FB; border-radius:12px;color:#000;font-size:16px">
                                                                                        <p style="font-size:13px">As
                                                                                            per the details you
                                                                                            provided, we’ve found the
                                                                                            perfect loan offers! Please
                                                                                            access your Loan Login links
                                                                                            to quickly apply for the
                                                                                        ...
                                                                                        <p>Please visit Your
                                                                                            Personalised Portal and
                                                                                            login with your credentials:
                                                                                        </p>
                                                                                        </p>
                                                                                        <a href="https://financercorp.com/customer/login"
                                                                                        ...
                                                                                        <p style="font-size:13px">
                                                                                            🔗 Additionally, we’ve
                                                                                            attached a 📄 PDF guide with
                                                                                            helpful tips to improve your
                                                                                            loan profile and boost your
                                                                                            chances of approval.
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                    ...
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            <a target="_blank"
                                                                                                ...
                                                                                                href="https://financercorp.com/privacy-policy">
                                                                                                Privacy Policy
                                                                                            </a>
                                                                                            &nbsp; | &nbsp;
                                                                                            <a target="_blank"
                                                                                                style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                href="https://financercorp.com/terms-and-conditions">
                                                                                                Terms &amp; Conditions
                                                                                            </a>
                                                                                            &nbsp; | &nbsp;
                                                                                            <a target="_blank"
                                                                                                style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                href="https://financercorp.com/raise-request">
                                                                                                Raise a request
                                                                                            </a>
                                                                                            &nbsp; | &nbsp;
                                                                                            <a target="_blank"
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            <a target="_blank"
                                                                                                style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                href="tel:0{{ config('constant.APP_NAME') }}">
